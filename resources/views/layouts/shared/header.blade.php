...
<div class="header">
	...
	<ul class="nav user-menu float-end">
		...
		<li class="nav-item dropdown has-arrow user-profile-list">
			...
			<a href="#" class="dropdown-toggle nav-link user-link" data-bs-toggle="dropdown">
				<div class="user-names">
					...
					{{--<span class="text-capitalize">{{ auth()->user()->roles->name }}</span>--}}
				</div>
				<span class="user-img">
		...
		<span class="mx-auto d-block m-auto p-4 text-center">
			<a class="nav-item btn-sm" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
		</span>
	</ul>
	...
	<div class="dropdown mobile-user-menu float-end">
		<span>
		<a class="btn btn-sm btn-primary" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
